...
<section class="budget-print-view">
  ...
  <table>
    ...
    <tfoot><tr><td colspan="4">Total mano de obra + materiales</td><td class="money"><?= money($viewLabor + $viewMaterials) ?></td></tr></tfoot>
  </table>
</section>
<?php endif; ?>
